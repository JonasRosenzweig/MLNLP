...
raw_train_ds = tf.keras.preprocessing.text_dataset_from_directory(
    "Tutorials_and_References/Imdb_Classification_Tutorial/aclImdb/train",
...
raw_test_ds = tf.keras.preprocessing.text_dataset_from_directory(
    "Tutorials_and_References/Imdb_Classification_Tutorial/aclImdb/test", batch_size=batch_size
)
